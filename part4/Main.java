...
public class Main {
    public static void main(String [] args) {
        ...
        // mixed tests
             ...
             System.out.print( "Plus.plus( (EString)Plus.plus( (EInteger)Plus.plus(b1, i1), s1), i1)" + ":"); 
             System.out.print(Plus.plus( (EString)Plus.plus( (EInteger)Plus.plus(b1, i1), s1), i1)); 
             System.out.println(":"); 
             System.out.println( "(Element)Plus.plus( (EString)Plus.plus( (EInteger)Plus.plus(b1, i1), s1), i1) instanceof EBoolean" + ":" + ((Element)Plus.plus( (EString)Plus.plus( (EInteger)Plus.plus(b1, i1), s1), i1) instanceof EBoolean) + ":"); 
             System.out.println( "(Element)Plus.plus( (EString)Plus.plus( (EInteger)Plus.plus(b1, i1), s1), i1) instanceof EInteger" + ":" + ((Element)Plus.plus( (EString)Plus.plus( (EInteger)Plus.plus(b1, i1), s1), i1) instanceof EInteger) + ":"); 
             System.out.println( "(Element)Plus.plus( (EString)Plus.plus( (EInteger)Plus.plus(b1, i1), s1), i1) instanceof EString" + ":" + ((Element)Plus.plus( (EString)Plus.plus( (EInteger)Plus.plus(b1, i1), s1), i1) instanceof EString) + ":");
        
             System.out.print( "Plus.plus( (EString)Plus.plus( (EInteger)Plus.plus(b1, i1), s2), i1)" + ":"); 
             System.out.print(Plus.plus( (EString)Plus.plus( (EInteger)Plus.plus(b1, i1), s2), i1)); 
             System.out.println(":"); 
             System.out.println( "(Element)Plus.plus( (EString)Plus.plus( (EInteger)Plus.plus(b1, i1), s2), i1) instanceof EBoolean" + ":" + ((Element)Plus.plus( (EString)Plus.plus( (EInteger)Plus.plus(b1, i1), s2), i1) instanceof EBoolean) + ":"); 
             System.out.println( "(Element)Plus.plus( (EString)Plus.plus( (EInteger)Plus.plus(b1, i1), s2), i1) instanceof EInteger" + ":" + ((Element)Plus.plus( (EString)Plus.plus( (EInteger)Plus.plus(b1, i1), s2), i1) instanceof EInteger) + ":"); 
             System.out.println( "(Element)Plus.plus( (EString)Plus.plus( (EInteger)Plus.plus(b1, i1), s2), i1) instanceof EString" + ":" + ((Element)Plus.plus( (EString)Plus.plus( (EInteger)Plus.plus(b1, i1), s2), i1) instanceof EString) + ":");
